<template>
  <div class="bg-white shadow rounded-xl hover:scale-105 transition-all">
      ...
      <div class="p-3">
        ...
        <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex architecto illo ducimus quibusdam sed sapiente, temporibus eaque quaerat id asperiores obc</p>
